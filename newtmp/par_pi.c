...
// par_pi.c
//
// Summary: This file contains code for estimating pi by summing the area of
// rectangles under the curve. The loop uses striping to parallelize the load.
//
// Author: Blake Lasky
// Created: Sept 2016
//******************************************************************************
...
int main(int argc, char *argv[]) {
    ...
    // Sum rectangles over section of integral
    pieceOfPi = 0.0;
	int i;
